...
public class SeedRunner implements CommandLineRunner {
  private final boolean seed; private final boolean seedReset;
  private final RegisterVehicleUseCase registerUC; private final SellVehicleUseCase sellUC;
  public SeedRunner(@Value("${app.seed:false}") boolean seed, @Value("${app.seedReset:false}") boolean seedReset,
    ...
    this.seed = seed; this.seedReset = seedReset; this.registerUC = registerUC; this.sellUC = sellUC;
  }
