...
public class GetVehicleHistoryUseCase {
  ...
  public GetVehicleHistoryUseCase(VehicleHistoryRepositoryPort repo){ this.repo = repo; }
  public List<VehicleHistory> execute(UUID vehicleId) { return repo.findByVehicleId(vehicleId); }
}
