...
public class SellVehicleUseCase {
  ...
  public SellVehicleUseCase(VehicleRepositoryPort repo, VehicleHistoryRepositoryPort history) { this.repo = repo; this.history = history; }
  public Vehicle execute(UUID id, String buyerCpf, OffsetDateTime soldAt) {
    ...
    String newJson = String.format("{\"soldToCpf\":\"%s\",\"soldAt\":\"%s\"}", updated.getSoldToCpf(), updated.getSoldAt());
