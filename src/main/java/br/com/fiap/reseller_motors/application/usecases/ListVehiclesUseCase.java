...
public class ListVehiclesUseCase {
  ...
  public ListVehiclesUseCase(VehicleRepositoryPort repo) { this.repo = repo; }
  ...
  public static class Result {
    public final List<Vehicle> items; public final int page; public final int pageSize; public final long total;
    public Result(List<Vehicle> items, int page, int pageSize, long total) { this.items = items; this.page = page; this.pageSize = pageSize; this.total = total; }
  }
}
